...
- `instructions/performance-best-practices.instructions.md`: Optimize after measurement **[CRITICAL]**
...
- `instructions/angular-development-standards.instructions.md`: Angular component patterns
...
- `instructions/aspnet-webapi-standards.instructions.md`: ASP.NET Web API patterns
- `instructions/csharp-coding-standards.instructions.md`: C# coding standards
- `instructions/unit-testing-standards.instructions.md`: Unit testing patterns
