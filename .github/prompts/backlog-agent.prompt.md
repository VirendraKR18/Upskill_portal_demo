...
- **Invoke**: `.github/prompts/create-epics.prompt.md` with `$ARGUMENTS` (if provided)
...
- **Invoke**: `.github/prompts/generate-wireframe.prompt.md`
...
- **Invoke**: `.github/prompts/create-user-stories.prompt.md`
